...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        p1.setBackground(new Color(4, 95, 85));
        ...
        JLabel name = new JLabel("Abidul Islam");
    ...
    public static JPanel formatLabel(String out){
        ...
        JLabel output = new JLabel("<html><p style=\"border-radius: 20px;\">"+out+"<p></html>");//"<html><p style=\"width: 150px\">"+out+"<p></html>"
    ...
    public static void main(String [] args){
        ...
        try {
            ServerSocket skt = new ServerSocket(9326);
            while (true){
                Socket s = skt.accept();
